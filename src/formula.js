...
const ALIAS_TO_ISOTOPE = { D: "2H", T: "3H" };

export function isotopeLabel(symbol, massNumber) {
...
export function normalizeSpeciesLabel(label) {
...
export function isotopeBaseSymbol(label) {
...
export function isotopeMassNumber(label) {
...
export function displaySpeciesLabel(label) {
  const normalized = normalizeSpeciesLabel(label);
...
function speciesSortKey(symbol, hasCarbon) {
...
export function hillSortSymbols(symbols) {
...
export function formatFormula(composition) {
...
export function formatChargeState(charge) {
...
export function formatIonFormula(formula, charge) {
